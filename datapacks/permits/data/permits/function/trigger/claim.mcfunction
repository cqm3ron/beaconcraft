...
execute if data entity @s {SelectedItem:{components:{"minecraft:custom_model_data":{strings:["permit"]}}}} if data entity @s SelectedItem.components."minecraft:custom_name" run data modify storage permits:shop shop set from entity @s SelectedItem.components."minecraft:custom_name"
execute if data entity @s {SelectedItem:{components:{"minecraft:custom_model_data":{strings:["permit"]}}}} if data entity @s SelectedItem.components."minecraft:custom_name" run item modify entity @s weapon.mainhand permits:setshopfromname
